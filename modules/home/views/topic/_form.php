...
<!-- 					<= $form->field($model, 'content', ['template' => '{input} {error}'])->textarea(['placeholder' => Yii::t('admin', 'Content')]) ?> -->
		...
		<div class="postinfobot">
			<div class="pull-left">
				<a href="<?= ($model->isNewRecord) ? Url::to(['/']) : Url::to(['topic/view', 'p' => Yii::$app->request->get('p')]) ?>">
					<button class="btn btn-default" type="button"><?= Yii::t('home', 'Cancel') ?></button>
				</a>
			</div>
			<div class="pull-right postreply">
				...
				<div class="pull-left">
					<?= Html::submitButton($model->isNewRecord ? Yii::t('home', 'Post') : Yii::t('home', 'Save'), ['class' => 'btn btn-primary']) ?>
				</div>
				<div class="clearfix"></div>
			</div>
