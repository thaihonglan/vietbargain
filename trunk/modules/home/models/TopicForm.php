		...
		if ($this->validate()) {
			...
			try {
				...
				if ($this->image) {
					...
					$image->resize('120', '120', Image::INVERSE)->save(Yii::$app->basePath . Yii::$app->params['postImagePath']['scaled'] . $post->image);
					$image->resize('37', '37', Image::INVERSE)->save(Yii::$app->basePath . Yii::$app->params['postImagePath']['icon'] . $post->image);
				}
