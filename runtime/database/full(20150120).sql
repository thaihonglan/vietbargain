...
-- Dumping data for table vietbargain.deal_type: ~2 rows (approximately)
...
-- Dumping data for table vietbargain.post: ~4 rows (approximately)
/*!40000 ALTER TABLE `post` DISABLE KEYS */;
INSERT INTO `post` (`id`, `title`, `content`, `short_content`, `user_id`, `contact_number`, `store_address`, `link`, `discount_code`, `is_owner`, `image`, `deal_type`, `like_number`, `dislike_number`, `comment_number`, `view_number`, `deal_begin_date`, `deal_end_date`, `create_datetime`, `modify_datetime`, `status`) VALUES
	(3, 'New topic', 'New content', 'Today, we\'re looking at three particularly interesting stories. Pinterest added a new location-based feature on Wednesday that uses Place Pins as a way to map out vacations and favorite areas. Southwest Airlines is providing Wi-Fi access from gate to gate for $8 per day through an onboard hotspot. And in an effort to ramp up its user base, Google Wallet is offering a debit card that can take out cash from.', 4, NULL, NULL, NULL, 'sadwqdwq', 0, NULL, 2, 0, 0, 0, 92, '2014-12-26', '2014-12-26', '2014-12-25 15:55:25', NULL, 0),
	(4, 'New topic 2', 'AADASDW', 'Today, we\'re looking at three particularly interesting stories. Pinterest added a new location-based feature on Wednesday that uses Place Pins as a way to map out vacations and favorite areas. Southwest Airlines is providing Wi-Fi access from gate to gate for $8 per day through an onboard hotspot. And in an effort to ramp up its user base, Google Wallet is offering a debit card that can take out cash from.', 4, NULL, NULL, NULL, 'ASDSADSA', 1, '', 2, 0, 0, 0, 0, '2014-12-16', '2014-12-31', '2014-12-25 15:55:25', NULL, 0),
	(6, 'New topic 1223asd', 'cascsavasdvsdvvds', 'Today, we\'re looking at three particularly interesting stories. Pinterest added a new location-based feature on Wednesday that uses Place Pins as a way to map out vacations and favorite areas. Southwest Airlines is providing Wi-Fi access from gate to gate for $8 per day through an onboard hotspot. And in an effort to ramp up its user base, Google Wallet is offering a debit card that can take out cash from.', 4, NULL, NULL, NULL, 'ALLO', 1, 'FHWDPW2kScvUZhh7WsLhSXsgmcekJNZ5.jpg', 1, 0, 0, 0, 0, '2014-12-25', '2014-12-31', '2014-12-25 15:55:25', NULL, 0),
	(7, 'Mama mia', '<!DOCTYPE html>\r\n<html>\r\n<head>\r\n</head>\r\n<body>\r\n<p>What the hell is it</p>\r\n</body>\r\n</html>', 'This is a short content', 4, NULL, NULL, NULL, 'ADSADSA', 0, 'gkaQVIk8TYhXLHTo3W0pQOBgWWlrqHIm.jpg', 2, 0, 0, 0, 1, '2015-01-14', '2015-01-30', '2015-01-10 16:04:44', NULL, 0);
...
-- Dumping data for table vietbargain.post_type: ~5 rows (approximately)
...
-- Dumping data for table vietbargain.post_type_allocation: ~4 rows (approximately)
...
-- Dumping data for table vietbargain.request: ~3 rows (approximately)
...
-- Dumping data for table vietbargain.user: ~2 rows (approximately)
...
INSERT INTO `user` (`id`, `type`, `email`, `password`, `facebook_login_id`, `first_name`, `last_name`, `identifier`, `city_id`, `address`, `age`, `contact_number`, `avatar`, `is_comment_unlimited`, `create_datetime`, `status`) VALUES
	(4, 0, '4rest.wind@gmail.com', '$2y$13$vZUgaZLbZB.STC3zM.1arOLcQJCdBZhtFiG78NwC0IrHOtHln5o9K', NULL, 'Minh ne aaa', 'Phan The', 'c12231456', 52, NULL, 31, '839012730921', 'le89cFRDoSOYwUwhgN5oyky1c6OUAZvj.jpg', 1, NULL, 1),
	(5, 0, 'thaihonglan@gmail.com', '$2y$13$h33yCJaDt3rcO75qOMLQ4eVf.TKuqk13Rl.79OrDj.kq1/8aJ4gGm', NULL, 'Thai Hong', 'Lan', NULL, 8, NULL, NULL, NULL, 'avatar.jpg', 1, '2015-01-11 08:56:53', 1);
